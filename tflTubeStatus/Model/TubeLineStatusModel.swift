...
struct TubeResult: Codable, Equatable {
    let type : String
    let id, name: String
    ...
    // Implement the == operator to compare two TubeResult instances
       static func == (lhs: TubeResult, rhs: TubeResult) -> Bool {
           // You can define your own logic for equality here
           // For example, you can compare the id and name properties
...
struct LineStatus: Codable {
    ...
    let statusSeverityDescription: String//StatusSeverityDescription
    let reason: String?
    let created: String
...
//        return 0
//    }  replace with below to get rid of warning
